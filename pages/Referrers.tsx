      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="max-w-3xl space-y-6">
            ...
            <p className="text-lg text-textDark/70 leading-relaxed">
              Die ambulante psychiatrische Pflege arbeitet handlungsorientiert im Hier und Jetzt. Ihr Fokus liegt auf der Umsetzung medizinischer und therapeutischer Empfehlungen im Alltag.
            </p>
          </div>
